...
import org.openqa.selenium.Alert;
	...
	public class BasePageObject {
		...
		static Logger logger= Logger.getLogger(BasePageObject.class);
		...
		public void waitForAnElement(final By theElement,int timeoutInSeconds) {
			try {
				...
				log("webElement[" + theElement + "] and waited for [" + timeoutInSeconds +" ] seconds to load" );
				WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
				log(" webdriver wait will waits for ["+ timeoutInSeconds +"] seconds to load");
				wait.until(ExpectedConditions.visibilityOf(element));
				log("waits for expected Element to visible ["+element +"]");
			} catch (Exception e) {
		...
		public  String getText(By theElement) {
			...
			WebElement element= driver.findElement(theElement);
			log("Getting the Webelement text ["+ theElement +"]");
	    ...
	    {
			WebElement element= driver.findElement(theElement);
			log("Getting the AttributeValue of the text ["+ theElement +"] and it's attribute value is [ "+ attributeValue + "]" );
		...
		public  void switchToFrame(String id) 
		{
			...
			log("Webdriver is switching to Frame [" + id +"]");
		}
	...
	public  String getPageTitle()
	{
		...
		public static void explicitWait(int miliSeconds) throws InterruptedException{
			...
			log("Explicit wait for: ["+ miliSeconds +"]Seconds ");
		}
